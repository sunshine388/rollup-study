...
UMD，是通用定义模块 (Universal Module Definition)，是 JavaScript 前后端跨平台的模块化方案。
...
- example 页面 `./example/amd/index.html`
...
- exmaple 中 AMD 模块入口文件 `./example/amd/main.js`
...
- exmaple 中 AMD 模块应用执行模块文件 `./example/amd/main.js`
...
- example 页面`./example/iife/index.html`
...
- example 脚本 `./example/cjs/index.js`
